        ...
        <div class="pcc-card pcc-dashboard-shell">
            <div class="pcc-dashboard-hero">
                <div class="pcc-dashboard-hero__copy">
                    <span class="pcc-section-kicker">Panel de control</span>
                    <h2>Configuracion general del plugin</h2>
                    <p>Administra Moodle, valores por defecto, accesos SSO, correos, logs y actualizaciones desde un solo lugar.</p>
                </div>
            ...
            <div class="pcc-overview-grid">
                <article class="pcc-overview-card">
                    ...
                    <p><?php echo $connection_ok ? 'La conexion principal responde correctamente.' : 'Revisa URL y token para habilitar la sincronizacion.'; ?></p>
                </article>
                <article class="pcc-overview-card">
                ...
                <article class="pcc-overview-card">
                    <span class="pcc-overview-card__label">Correos y acceso</span>
                    <strong class="pcc-overview-card__value"><?php echo $email_enabled ? 'Correo activo' : 'Correo inactivo'; ?></strong>
                    <p>SSO <?php echo $sso_enabled ? 'habilitado' : 'deshabilitado'; ?> para alumnos y compras.</p>
                </article>
                <article class="pcc-overview-card">
                    ...
                    <p><?php echo !empty($update_available) ? 'Hay una nueva version lista para instalar.' : 'No hay nuevas versiones detectadas.'; ?></p>
                </article>
            </div>

            <div class="pcc-dashboard-actions">
                <button type="button" class="button button-primary pcc-quick-tab" data-jump-tab="moodle">Configurar Moodle</button>
                <button type="button" class="button pcc-quick-tab" data-jump-tab="emails">Configurar correos</button>
                <button type="button" class="button pcc-quick-tab" data-jump-tab="updates">Revisar updates</button>
            </div>
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Pega aqui el token del servicio web de Moodle con permisos para consultar cursos, categorias y usuarios.</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Es el ID numerico del rol de estudiante dentro de Moodle. En muchos sitios suele ser `5`, pero puede variar.</p>
                        </td>
                    </tr>
                </table>
            </section>
                ...
                <table class="form-table" role="presentation">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Se usara cuando un curso no traiga imagen desde Moodle o no tenga imagen destacada asignada.</p>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Valor usado cuando el curso no tenga precio definido. Ingresa solo el monto, por ejemplo `49000`.</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Nombre que se mostrara si Moodle no informa docente, relator o instructor para el curso.</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Texto alternativo para completar la descripcion del producto cuando Moodle no entregue contenido suficiente.</p>
                        </td>
                    </tr>
                </table>
            </section>
                ...
                <table class="form-table" role="presentation">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Activa el ingreso automatico al aula para que el alumno no tenga que iniciar sesion manualmente en Moodle.</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Direccion base que usa Moodle para el acceso directo. Debe ser la URL exacta del endpoint SSO configurado en tu plataforma.</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Si esta activo, al completar la compra el usuario sera enviado directamente al acceso de su aula o curso.</p>
                        </td>
                    </tr>
                </table>
            </section>
                ...
                <table class="form-table" role="presentation">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Envia automaticamente al alumno un correo con sus datos de acceso despues de la compra o matricula.</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Escribe el titulo del correo que vera el alumno en su bandeja de entrada.</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Puedes personalizar el diseno del correo. Si no conoces HTML, modifica solo los textos visibles y conserva las variables.</p>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Cantidad de veces que el sistema volvera a intentar una matricula fallida antes de marcarla como error.</p>
                        </td>
                    </tr>
                </table>
                ...
                <table class="form-table" role="presentation">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Guarda mas detalle tecnico en los logs. Usalo para diagnostico y desactivalo cuando no sea necesario.</p>
                        </td>
                    </tr>
                </table>
            </section>
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">URL directa al archivo `release.json` que informa la ultima version disponible del plugin.</p>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="pcc-field-help">Si lo activas, WordPress podra instalar nuevas versiones automaticamente cuando el update server las detecte.</p>
                        </td>
                    </tr>
                </table>
            </section>
